...
export const DESIGN_SYSTEM = {
  title: 'Studywell Design System',
  description:
    'Ink & Marigold: a calm, editorial visual language for student productivity surfaces.',
} as const;
    ...
    entries: [
      {
        id: 'brand-language',
        name: 'Brand language',
        description: 'Studywell identity, voice, and Ink & Marigold principles.',
        Page: BrandPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Quiet reveals and small, purposeful transitions.',
        Page: MotionPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'A Studywell metric surface using the extracted hierarchy.',
