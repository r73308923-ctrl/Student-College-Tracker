# Migrating Expo UI to Studywell Design System

Read `artifacts/studywell-design-system/docs/AGENTS.md` and
`artifacts/studywell-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/studywell-design-system/lib/native-theme` and
  `@workspace/studywell-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/studywell-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/studywell-design-system` and retains only
