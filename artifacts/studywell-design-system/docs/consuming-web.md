# Consuming Studywell Design System in web apps

Read `artifacts/studywell-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/studywell-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/studywell-design-system/styles.css";
```
...
`node_modules/@workspace/studywell-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/studywell-design-system/components/ui/button";
import { cn } from "@workspace/studywell-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/studywell-design-system/hooks/use-toast";
```
...
`@workspace/studywell-design-system/components/ui/button`. Run the app's typecheck
