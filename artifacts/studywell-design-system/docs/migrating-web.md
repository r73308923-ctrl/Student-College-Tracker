# Migrating web UI to Studywell Design System

Read `artifacts/studywell-design-system/docs/AGENTS.md` and
`artifacts/studywell-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/studywell-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/studywell-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/studywell-design-system/hooks/use-toast`
