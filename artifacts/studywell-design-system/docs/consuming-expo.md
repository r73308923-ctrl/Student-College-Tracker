# Consuming Studywell Design System in Expo apps

Read `artifacts/studywell-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/studywell-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/studywell-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/studywell-design-system/lib/native-theme";
import { useColors } from "@workspace/studywell-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/studywell-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/studywell-design-system/components/native/badge";
import { Button } from "@workspace/studywell-design-system/components/native/button";
import { Card } from "@workspace/studywell-design-system/components/native/card";
```
...
Import and render
`@workspace/studywell-design-system/components/native/button`, then run Expo
