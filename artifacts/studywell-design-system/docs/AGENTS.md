# Studywell Design System design system
...
workspace package (`@workspace/studywell-design-system`): other artifacts depend
...
- `docs/references/` — extracted source evidence, the component/pattern
  inventory, and one reference contract per reusable Studywell pattern. Read
  these before extending the system or migrating the Student College Tracker.
...
`@workspace/studywell-design-system/components/...`. Never use a `@/` alias inside
...
This package was extracted from the Student College Tracker source app. Its
visual language is named **Ink & Marigold**: warm parchment surfaces, deep teal
structure, marigold focus accents, coral semantic emphasis, Fraunces editorial
headings, DM Sans UI text, and IBM Plex Mono data labels. The source did not
contain a standalone logo asset, so the preview intentionally uses the
Studywell wordmark as text rather than inventing an image mark.
...
for `@workspace/studywell-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/studywell-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/studywell-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/studywell-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/studywell-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/studywell-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/studywell-design-system/docs/migrating-expo.md`
